...
const setMenu = items => {
    ...
    const div = document.createElement('div');
        div.innerHTML = `
    <li onclick="getId('${menu.category_id}','${menu.category_name}')" class='bg-rose-400 text-white font-bold p-2 rounded-lg cursor-pointer mt-2 lg:mt-0'>${menu.category_name}</li>
    `;
            ...
            <div class="card-body w-full lg:w-2/3">
                ...
                <div class="w-full lg:flex justify-evenly items-center">
                    <div class="lg:flex gap-5">
                        <img class="w-8 rounded-full" src="${news.author.img}" alt="">
                        <div>
                    ...
                    <div class="rating">
                        <input type="radio" name="rating-2" class="mask mask-star-2 bg-black" />
                        <input type="radio" name="rating-2" class="mask mask-star-2 bg-black" checked />
                        <input type="radio" name="rating-2" class="mask mask-star-2 bg-black" />
                        <input type="radio" name="rating-2" class="mask mask-star-2 bg-slate-500" />
                        <input type="radio" name="rating-2" class="mask mask-star-2 bg-slate-200" />
                    </div>
